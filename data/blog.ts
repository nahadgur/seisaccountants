...
export const blogArticles: BlogArticle[] = [
...

  {
    ...
    reviewed: true,
    content: [
      { type: 'p', text: 'Most founders pitch SEIS on the 50% income tax relief, and most investors come for it. But SEIS carries a second capital gains tax benefit that is easy to miss and surprisingly generous: an investor who reinvests a chargeable gain into SEIS shares can have half of that gain exempted from capital gains tax outright. It is a separate relief from the well-known exemption on the SEIS shares themselves, and it is one of the strongest cards a founder can play with an angel sitting on a recent gain. This article sits beneath the [complete SEIS and EIS guide for UK startups](/guides/seis-eis-guide-uk-startups/).' },
      { type: 'p', text: 'It works alongside the companion articles on [how much you can raise](/blog/seis-eis-investment-limits-how-much-you-can-raise/) and on the three-year holding period and the disposal events that can unwind relief, at /blog/seis-eis-three-year-holding-period-disposal-events/. Reinvestment relief depends on getting the income tax relief first, so it also leans on the advance assurance and compliance steps covered at /blog/seis-eis-advance-assurance-hmrc/.' },
