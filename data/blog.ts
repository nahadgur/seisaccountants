...
export const blogArticles: BlogArticle[] = [
  ...
  // ===========================================================
  {
    ...
    content: [
      ...
      { type: 'p', text: 'The role rules and the anti-avoidance rules are designed to dovetail. A founder who meets the technical wording of the EIS director exception, but whose arrangement substantively converts salary into reliefed investment, can still fail the [risk-to-capital and anti-avoidance tests](/blog/seis-eis-anti-avoidance-tax-motive-trading-substance/). A director investment that returns value through loans or service payments can also breach the [holding-period and value-received rules](/blog/seis-eis-three-year-holding-period-disposal-events/).' },
...

  {
    ...
    reviewed: true,
    content: [
      { type: 'p', text: 'Most founders pitch SEIS on the 50% income tax relief, and most investors come for it. But SEIS carries a second capital gains tax benefit that is easy to miss and surprisingly generous: an investor who reinvests a chargeable gain into SEIS shares can have half of that gain exempted from capital gains tax outright. It is a separate relief from the well-known exemption on the SEIS shares themselves, and one of the strongest cards a founder can play with an angel sitting on a recent gain. The [wider SEIS and EIS framework](/guides/seis-eis-guide-uk-startups/) sets out where this relief fits among the schemes\' other incentives.' },
      { type: 'p', text: 'Reinvestment relief depends on first securing the income tax relief, so it is shaped by [how much an investor can put in](/blog/seis-eis-investment-limits-how-much-you-can-raise/), by the [three-year holding period and the disposal events](/blog/seis-eis-three-year-holding-period-disposal-events/) that can unwind a claim, and by the [advance assurance and compliance steps](/blog/seis-eis-advance-assurance-hmrc/) the company has to clear before any certificate reaches an investor.' },
      ...
      { type: 'p', text: 'The mechanism is simple at its core. If an investor makes a chargeable gain on disposing of any asset, and reinvests an amount of that gain into qualifying SEIS shares, they can claim to treat 50% of the gain as exempt from capital gains tax. The exemption is capped: the maximum reinvestment relief is £100,000, which is half of the [£200,000 maximum SEIS investment](https://www.british-business-bank.co.uk/business-guidance/guidance-articles/finance/what-is-the-seed-enterprise-investment-scheme-seis) an investor can make in a tax year. That £100,000 ceiling applies to investments made from 6 April 2023, having previously been £50,000.' },
      ...
      { type: 'p', text: 'The practical difference is large. SEIS hands back tax permanently on half the gain; EIS hands back tax temporarily on potentially all of the gain. An investor [choosing between the two schemes](/blog/seis-vs-eis-key-differences-founders-must-know/) on capital gains grounds alone is weighing a permanent 50% exemption against a full but temporary deferral. The table below sets the two side by side.' },
      {
        type: 'table',
      ...
      { type: 'p', text: 'Reinvestment relief is not immune to the clawback rules that govern the SEIS shares. If the income tax relief is withdrawn, for example because the investor disposes of the SEIS shares inside the [three-year holding window](/blog/seis-eis-three-year-holding-period-disposal-events/), the reinvestment relief can be withdrawn with it. Because the two reliefs are linked, an event that unwinds the income tax claim tends to unwind the capital gains exemption as well.' },
