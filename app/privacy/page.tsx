...
export const metadata: Metadata = {
  ...
  description: 'How startupaccountants.uk collects, uses, and protects your personal data, and what happens when you submit an enquiry.',
        ...
        <div className="container-width py-12 md:py-16 max-w-3xl">
          ...
          <div className="space-y-10 text-[14.5px] leading-[1.8] text-ink-700 font-sans">
            ...
            <section>
              ...
              <p>
                startupaccountants.uk is an independent online matching service that connects UK startup founders with qualified accountants in our partner network. Throughout this policy, &apos;we&apos;, &apos;us&apos; and &apos;our&apos; refer to startupaccountants.uk as the operator of this website and the controller of the personal data you submit.
              </p>
              <p className="mt-3">
                For transparency: this site operates under the trading name &apos;startupaccountants&apos;. We do not yet operate as a separately incorporated legal entity. If you need to identify a named individual for a data protection request, please contact us at <a href="mailto:hello@startupaccountants.uk" className="font-display italic text-brand-500 hover:text-brand-700">hello@startupaccountants.uk</a> and we will provide one.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                To exercise any of these rights, email us at <a href="mailto:hello@startupaccountants.uk" className="font-display italic text-brand-500 hover:text-brand-700">hello@startupaccountants.uk</a>. We will respond within 30 days.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                For any privacy question, data access request, consent withdrawal, or complaint, email <a href="mailto:hello@startupaccountants.uk" className="font-display italic text-brand-500 hover:text-brand-700">hello@startupaccountants.uk</a>.
              </p>
            </section>
